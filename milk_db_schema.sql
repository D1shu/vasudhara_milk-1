...
(1, 'Haveli'), (1, 'Mulshi'), (1, 'Maval'),
(2, 'Kurla'), (2, 'Andheri'), (2, 'Borivali');

INSERT INTO villages (taluka_id, name) VALUES 
(1, 'Lohegaon'), (1, 'Wagholi'), (1, 'Kharadi'),
(2, 'Pirangut'), (2, 'Lavale'), (2, 'Paud');

INSERT INTO routes (route_number, route_name, vehicle_number, driver_name, driver_mobile) VALUES 
('R001', 'Pune East Route', 'MH-12-AB-1234', 'Ramesh Kumar', '9876543210'),
('R002', 'Pune West Route', 'MH-12-CD-5678', 'Suresh Patil', '9876543211'),
('R003', 'Mulshi Route', 'MH-12-EF-9012', 'Ganesh Rao', '9876543212');

INSERT INTO anganwadi (village_id, route_id, aw_code, name, type, total_children, pregnant_women, contact_person, mobile) VALUES 
(1, 1, 'AW001', 'Lohegaon Anganwadi Center 1', 'anganwadi', 45, 5, 'Sunita Devi', '9876543220'),
(1, 1, 'AW002', 'Lohegaon Primary School', 'school', 120, 0, 'Rajesh Sharma', '9876543221'),
(2, 1, 'AW003', 'Wagholi Anganwadi Center', 'anganwadi', 38, 3, 'Meera Joshi', '9876543222'),
(3, 1, 'AW004', 'Kharadi Balwadi', 'anganwadi', 52, 7, 'Anita Pawar', '9876543223'),
(4, 3, 'AW005', 'Pirangut Anganwadi', 'anganwadi', 30, 4, 'Savita More', '9876543224');

INSERT INTO users (anganwadi_id, name, mobile, email, role, status) VALUES 
(1, 'Sunita Devi', '9876543220', 'sunita@example.com', 'user', 'active'),
(2, 'Rajesh Sharma', '9876543221', 'rajesh@example.com', 'user', 'active'),
(3, 'Meera Joshi', '9876543222', 'meera@example.com', 'user', 'active'),
(4, 'Anita Pawar', '9876543223', 'anita@example.com', 'user', 'active'),
(5, 'Savita More', '9876543224', 'savita@example.com', 'user', 'active'),
...
('company_address', 'Pune, Maharashtra', 'Company address'),
