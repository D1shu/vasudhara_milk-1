...
// Map PHP day of week to column names (only mon-fri exist in table)
$dayColumns = [
    0 => '0', // Sunday - no delivery
    1 => 'mon_qty', // Monday
    2 => 'tue_qty', // Tuesday
    3 => 'wed_qty', // Wednesday
    4 => 'thu_qty', // Thursday
    5 => 'fri_qty', // Friday
    6 => '0'  // Saturday - no delivery
];

// Build query with CASE statement for day-specific quantity
$sql = "
    SELECT wo.id,
           CASE DAYOFWEEK('$date')
               WHEN 2 THEN wo.mon_qty
               WHEN 3 THEN wo.tue_qty
               WHEN 4 THEN wo.wed_qty
               WHEN 5 THEN wo.thu_qty
               WHEN 6 THEN wo.fri_qty
               ELSE 0
           END as quantity,
           wo.total_bags,
